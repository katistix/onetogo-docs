...
-   `npm run cy:test` - Runs `next dev` in _test mode_, setting the following env variables: `FIRESTORE_EMULATOR_HOST='127.0.0.1:8080' NEXT_PUBLIC_NODE_ENV='test' NODE_ENV=test`
